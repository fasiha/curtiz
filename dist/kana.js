...
exports.kata2hiraFast = kata2hiraFast;
if (module === require.main) {
    let s = `『バフィー 〜恋する十字架〜』とエンジェルのクリエイターであるジョス・ウィードンによりクリエイトおよび3エピソードが監督された。彼の製作会社である、ミュータント・エネミー・プロダクションズにプロデュースされた。自然主義の伝統的な西部劇をモチーフとしており、ウィドゥンはティム・マイニアとともにエグゼクティブプロデューサーを務めた。
